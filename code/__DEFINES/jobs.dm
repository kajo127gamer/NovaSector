...
#define JOB_DISPLAY_ORDER_PEASANT 1
#define JOB_DISPLAY_ORDER_ASSISTANT 2
...
#define DEPARTMENT_BITFLAG_PEASANT (1<<8)
#define DEPARTMENT_PEASANT "Peasant"
