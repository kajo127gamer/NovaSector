...
/datum/emote/living/aauugghh
	...
	message = "exclaims AAAAAAAUUUUUUUUUGH!"
	emote_type = EMOTE_AUDIBLE
	vary = FALSE
...
/datum/emote/living/breakbad
	...
	message = "looks like about to cook meth"
	emote_type = EMOTE_AUDIBLE
	vary = FALSE
...
/datum/emote/living/fag
	...
	message = "thinks you are a faggot!"
	emote_type = EMOTE_AUDIBLE
	vary = FALSE
...
/datum/emote/living/missouri
	...
	message = "belives they are in missouri"
	emote_type = EMOTE_AUDIBLE
	vary = FALSE
...
/datum/emote/living/puzzled
	...
	message = "looks completly puzzled..."
	emote_type = EMOTE_AUDIBLE
	vary = FALSE
...
/datum/emote/living/rizz
	...
	message = "looks single and ready to mingle~"
	emote_type = EMOTE_AUDIBLE
	vary = FALSE
